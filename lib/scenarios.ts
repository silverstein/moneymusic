...
export const wealthScenarios: WealthScenario[] = [
  {
    ...
    icon: '☀️',
    prompts: [
      'Epic orchestral sunrise with electric guitar, building from gentle piano to explosive drums, motivational wealth anthem',
      'Cinematic morning energy, blend of trap beats and classical strings, billionaire mindset activation music',
      'Uplifting electronic symphony with brass hits, corporate power vibes, fortune 500 CEO morning routine',
    ],
    duration: 180_000,
    category: 'morning',
    energy: 'high',
  ...
  },
  {
    ...
    icon: '🎯',
    prompts: [
      'Minimal techno with subtle wealth affirmation frequencies, deep focus binaural beats for productivity',
      'Ambient electronic with soft piano, concentration enhancing tones, millionaire mindset subliminal rhythm',
      'Lo-fi beats with motivational undertones, study music for financial literacy and wealth education',
    ],
    duration: 300_000,
    category: 'focus',
    energy: 'moderate',
